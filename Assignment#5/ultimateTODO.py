# Lyle Osburne  11-08-2025
# Assignment #5
# This code is an organization of lists, you can add, delete, and move items around the lists as you need. it will also print the lists as they change.
...
def addItem(item, toList, todoList):
    ...
    if not itemFound:
        ...
        print("ERROR: '{}' already exists in '{}' at index {}.".format(item, keyName, index))
...
def deleteItem(item, todoList):
    ...
    if itemFound:
        ...
        print("ERROR: '{}' does not exist.".format(item))
    ...
    while True:
        ...
        if choice == "a":
            ...
            if not checkIfListEmpty(todoList):
                ...
                toList = input("Enter a list to move to: ")
                while toList not in todoList:
                    print("ERROR: '{}' is not a valid list.".format(toList))
                    toList = input("Enter a list to move to: ")
